...
you can try the api here [https;//covid-19api.heroku.com/](https;//covid-19api.heroku.com/) or [![Deploy](https://www.herokucdn.com/deploy/button.png)](https://heroku.com/deploy)
