...
func (wh *waHandler) HandleTextMessage(message whatsapp.TextMessage) {
	...
	param := ""
	log.Printf("Get message from %s, with message %s", message.Info.RemoteJid, message.Text)
...
func sendImage(wac *whatsapp.Conn, RJID string, url string) {
	...
	msg := whatsapp.ImageMessage{
		...
		Type: "image/jpeg",
		Caption: "Statistik dari kawalcovid19.co.id",
